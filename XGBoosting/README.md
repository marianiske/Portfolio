...
# Pre-Processing
I collected the dataset from [football-data.co.uk](https://www.football-data.co.uk/data.php) and enriched it with additional features based on a simple stochastic model using expected goals (xG). The resulting dataset includes all matches from the top five European leagues since the 2014/15 season, comprising more than 40,000 observations with 42 features each.
